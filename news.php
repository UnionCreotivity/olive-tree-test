...
function countChineseAndEnglish($string) {
    // 中文字符数量
    $chineseCount = preg_match_all('/[\x{4e00}-\x{9fa5}]/u', $string, $matches);

    // 英文字符数量
    $englishCount = preg_match_all('/[a-zA-Z0-9]/', $string, $matches);


    return round(($chineseCount*1)+$englishCount);
}
?>
        ...
        <div data-barba="container" data-barba-namespace="news">
            ...
            <div class="news-body">
                <div class="news-main">
                    ...
                    <div id="news_list" class="page-contaniner">
                        <img class="top-tree-shadow" src="assets/images/page_news/tree_shadow.png" alt="tree_shadow"
                            srcset="">

                        <div class="page-title-box">
                            <div class="page-title-img">
                                <!-- <img src="assets/images/page_news/page_news.svg" alt="page_news" srcset=""> -->
                                <svg id="page-title-img-svg" data-name="圖層 2" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 265.7 132.58">
                                    <defs>
                                        <style>
                                            .news-title-svg {
                                                fill: #b6c396;
                        ...
                        <div class="page-content">
                            <div class="content">
                                ...
                                <?php 
                                  $news=$pdo->select("SELECT Tb_index, aTitle_one, aImg, StartDate, update_num FROM appNews WHERE OnLineOrNot=1 ORDER BY StartDate DESC, Tb_index DESC");
                                  foreach ($news as $nOne) {
                                    $txtCount=countChineseAndEnglish($nOne['aTitle_one']);
                                    $txtNum=mb_strlen($nOne['aTitle_one'], 'utf-8');
                                    $imgUrl=IMG_URL.$nOne['aImg'].'?'.$nOne['update_num'];
                                    echo '<div class="item">
                                            <div class="item-img">
                                                <a href="news_content.php?Tb_index='.$nOne['Tb_index'].'">
                                                    <img class="item-font" src="'.$imgUrl.'" alt="'.$nOne['aTitle_one'].'" srcset="">
                                                    <div class="more-moblie">
                                                        <button class="more-btn">more</button>
                                                    </div>
                                                    <img class="item-back-img" src="assets/images/page_news/back.png" alt=""
                                                        srcset="">
                                                    <div class="item-back">
                                                        <div class="back-content">
                                                            <div class="date">
                                                                '.date('Y.m.d', strtotime($nOne['StartDate'])).'
                                                            </div>
                                                            <div class="title">
                                                               '.$nOne['aTitle_one'].'
                                                            </div>
                                            ...
                                            <div class="circle-box">
                                                <svg class="circle-svg" viewBox="0 0 400 125">
                                                    <path id="circle" fill="transparent" d="M100 10a100 100 0 00200 0" stroke="none" />
                                                    <text font-size="12px">
                                                        <textPath text-anchor="middle" startOffset="53%" data-length="'.(110+round(($txtCount*9))).'" textLength="200" href="#circle">
                                                            '.date('Y.m.d', strtotime($nOne['StartDate'])).' '.$nOne['aTitle_one'].'
                                                        </textPath>
                                                    </text>
                                                </svg>
                                            </div>
                ...
                <img class="bottom-tree-shadow" src="assets/images/page_news/tree_shadow.png" alt="tree_shadow"
                    srcset="">
